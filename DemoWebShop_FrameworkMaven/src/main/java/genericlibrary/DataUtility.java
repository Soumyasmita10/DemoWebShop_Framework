...
public class DataUtility
{
    ...
    public Object[][] getMultipleDataFromExcel(String sheetName) throws EncryptedDocumentException, IOException
    {
   	...
   	int lastRowNumber = sh.getPhysicalNumberOfRows();// to getting the last index number of row
   	int lastCellNumber = sh.getRow(0).getPhysicalNumberOfCells();// to getting the last cell number
